...
public class TechnicalComponents extends TestSetup {
	...
	public static void navigatetoUrl(String url) {
		try {
			...
			if (url != "") {
				driver.get(url);
				Cookie cookie = new Cookie("sm_test_geo", "US");
	...
	public static String getDate(String PlanType, String format) {
		try {
			...
			c.getTime();
			String strDateFormat = format; // Date format is Specified
			SimpleDateFormat objSDF = new SimpleDateFormat(strDateFormat); // Date format string is passed as an
																			// argument to
			String datess = objSDF.format(c.getTime()); // the Date format object
